...
pub(crate) const NIX_COMMAND: &str = "nix command";
pub(crate) const NIX_FLAKE_COMMAND: &str = "nix flake command";
pub(crate) const NIX_PROFILE_COMMAND: &str = "nix profile command";
pub(crate) const NIX_STORE_COMMAND: &str = "nix store command";
