...
bitflags::bitflags! {
    ...
    pub struct Modifiers: u8 {
        ...
        /// Super + Alt
        const SUPER_ALT = Self::SUPER.bits() | Self::ALT.bits();
        /// Super + Alt + Shift
        const SUPER_ALT_SHIFT = Self::SUPER.bits() | Self::ALT.bits() | Self::SHIFT.bits();
        /// Super + Ctrl
        const SUPER_CTRL = Self::SUPER.bits() | Self::CTRL.bits();
        /// Super + Ctrl + Shift
        const SUPER_CTRL_SHIFT = Self::SUPER.bits() | Self::CTRL.bits() | Self::SHIFT.bits();
        /// Super + Ctrl + Alt
        const SUPER_CTRL_ALT = Self::SUPER.bits() | Self::CTRL.bits() | Self::ALT.bits();
        /// Super + Ctrl + Alt + Shift
        const SUPER_CTRL_ALT_SHIFT =
            Self::SUPER.bits() | Self::CTRL.bits() | Self::ALT.bits() | Self::SHIFT.bits();
        /// Ctrl + Shift
